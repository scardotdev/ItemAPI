...
maintainer through the contact options on the repository owner's GitHub profile.
Do not include sensitive incident details in a public issue. If the reported
person controls that contact route, report the incident to another repository
maintainer where possible.

All complaints will be reviewed and investigated promptly and fairly. Community
leaders must respect the privacy and security of the reporter of any incident.
...
the community. Violating these terms may lead to a permanent ban.
